...
std::vector<CGameObject*> QuadTree::mListDynamicGameObject;
...
bool QuadTree::IsContain(CGameObject* gameObject)
{
...
void QuadTree::InsertStaticObject(CGameObject* gameObject)
{
...
void QuadTree::InsertDynamicObject(CGameObject* gameObject)
{
	mListDynamicGameObject.push_back(gameObject);
}

void QuadTree::Retrieve(std::vector<CGameObject*>& return_objects_list, CGameObject* gameObject)
{
	if (mNodes)
	{
		if (mNodes[0]->IsContain(gameObject))
